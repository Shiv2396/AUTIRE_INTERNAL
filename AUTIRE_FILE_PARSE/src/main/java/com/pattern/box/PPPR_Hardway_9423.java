...
public class PPPR_Hardway_9423
{
...
//	System.out.println(path1);
	...
	File 	  		xFile  = new File("1553175299423_Hard Way Inc_Sorted.xml");
	File 	  		cFile  = new File("1553175299423_Hard Way Inc_Config.json");
...
public static JSONObject getEmpData(Node xNode) throws JSONException {
	...
	for (int j=0; j<xRows.length();j++) {
		...
		//System.out.println("val="+val);
				...
				jItem.put("pp_pr_period_ending_date","12/31/2016");
