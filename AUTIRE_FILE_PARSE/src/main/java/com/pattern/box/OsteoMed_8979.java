package com.pattern.box;
	...
	public static void main(String[] args) throws DocumentException, JSONException, IOException, InterruptedException, NumberFormatException, ParseException {
		File 	  		xFile  = new File("1553669168979_1529591921719_011517 Payroll_Register_INPSorted.xml");//sortedxml
		File 	  		cFile  = new File("1553669168979_1529591921719_011517 Payroll_Register_Config.json");
		...
		xList = dcXML.getRootElement().selectNodes("//text[@left='22'and @font='5']");
